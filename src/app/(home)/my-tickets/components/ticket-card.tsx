    ...
    <div className="ticket-card flex justify-between items-center rounded-[20px] gap-[30px] p-5 bg-flysha-bg-purple">
      ...
      <div className="flex h-full justify-between items-start md:items-center gap-[30px]">
        <Link
          ...
          className="flex items-center font-bold text-flysha-black bg-flysha-light-purple rounded-full p-2 md:p-[12px_20px] md:h-[48px] transition-all duration-300 hover:shadow-[0_10px_20px_0_#B88DFF]"
        >
